...
### 7. 🕊️ 영성·예배 중심 4단계 브랜딩 & 헤리티지 사역관
- **★★★★ (최우선)**: "기도하는 동산, 감림산기도원" / "연중 쉬지 않는 예배" (365일 무휴 4부 예배, 화요구국철야, 금요철야, 설교영상)
- **★★★★ (역사·사역자)**: 40주년 다큐 영상(`efgD497OF-E`), 이옥란 원장 인사말 & 3대 사명 구호(“세상을 새롭게, 교회를 부흥케, 가정을 복되게”), 이은호 원목 소개
- **★★★ (핵심 사역)**: "교회와 기관들의 소중한 행사를 지원하는 대관 예약" / "개인과 가족의 행복을 위한 숙소 예약"
- **★★ (동역 네트워크)**: 오병이어 캠프 (`5025camp.kr`), 사회복지법인 혜성원 (`로뎀요양i.com`)
- **★ (안내 및 지원)**: 오시는 길 (양산역/노포역 교통편, 카카오맵 길찾기, 직통 문의 `055-374-4111`)

---

## 🚀 원클릭 실서버 배포 가이드

로컬에서 작업 완료 후 아래 명령어를 실행하면 iWinV 실서버로 즉시 배포 및 헬스 체크가 완료됩니다:
